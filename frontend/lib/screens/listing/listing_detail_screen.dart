...
class _ListingDetailScreenState extends State<ListingDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final title = widget.listing['title'] ?? 'Unknown';
    final priceRaw = widget.listing['price']?.toString() ?? '0';
    final price = '\$$priceRaw';
    final condition = widget.listing['condition'] ?? 'used';
    final city = widget.listing['city'] ?? 'Unknown Location';
    final isPromoted = widget.listing['is_promoted'] ?? false;
    ...
    final ownerInitials = ownerName.isNotEmpty ? ownerName[0].toUpperCase() : 'U';
              ...
              child: Column(
                ...
                children: [
                  ...
                  AppButton(
                    text: 'Message Seller',
                    onPressed: () async {
                      final ownerId = widget.listing['owner']?['id'];
